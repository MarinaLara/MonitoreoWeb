...
<!-- daterangepicker -->
<script src="<?= base_url(); ?>template/admin-lte/plugins/moment/moment.min.js"></script>
<script src="<?= base_url(); ?>template/admin-lte/plugins/daterangepicker/daterangepicker.js"></script>
<!-- AdminLTE -->
<script src="<?= base_url(); ?>template/admin-lte/dist/js/adminlte.js"></script>
<!-- sweetalert2 LTE -->
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>

<script src="<?= base_url(); ?>template/admin-lte/plugins/chart.js/Chart.min.js"></script>
